...
class SalidaDeCampoServiceImpl(SalidaDeCampoService):
    ...
    def editar_salida(self, id: int, **datos) -> SalidaDeCampo:
        ...
        salida.tecnicos_asignados = datos.get('tecnicos_asignados', salida.tecnicos_asignados)
        salida.cuerpos_de_agua_asignados = datos.get('cuerpos_de_agua_asignados', salida.cuerpos_de_agua_asignados)
